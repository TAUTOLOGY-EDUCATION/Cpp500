...
vector<int> shiftRight(vector<int> arrayA, int k) {
...
บรรทัดที่ 17 : ประกาศฟังก์ชันชื่อ shiftRight ที่รับ parameter เป็น arrayA และ k
...
บรรทัดที่ 21-26 : ทำการ shift right arrayA แล้วเก็บค่าไว้ใน shiftArrayA
บรรทัดที่ 27 : return shiftArrayA

บรรทัดที่ 30 : ฟังก์ชัน main โปรแกรมจะเริ่มรันฟังก์ชันนี้เป็นฟังก์ชันแรก
บรรทัดที่ 31 : print ค่าที่ได้จาก shiftRight({1, 2, 3, 4, 5}, 1)
