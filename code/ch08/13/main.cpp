...
บรรทัดที่ 09-11 : ถ้า number หารด้วย 3 และ 5 ลงตัว ให้พิมพ์ "divisible by 3 and 5"
บรรทัดที่ 12-14 : ถ้า number หารด้วย 3 และ 5 ไม่ลงตัว ให้พิมพ์ "not divisible by 3 and 5"
...
Line 9-11 : If number is divisible by 3 and 5, print "divisible by 3 and 5".
Line 12-14 : If number is not divisible by 3 and 5, print "not divisible by 3 and 5".
